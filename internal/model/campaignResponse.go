...
type CampaignResponseFormat struct {
	ID               int    `json:"id"`
...
func FormatCampaign(campaign Campaign) CampaignResponseFormat {
	formatter := CampaignResponseFormat{
		ID:               campaign.ID,
...
func FormatCampaigns(campaigns []Campaign) []CampaignResponseFormat {
	var campaignsFormatter []CampaignResponseFormat
